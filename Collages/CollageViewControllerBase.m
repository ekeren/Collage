...
#import "CollageViewControllerBase.h"
#import "Collage.h"
...
@interface CollageViewControllerBase ()
//Collection Views
...
@implementation CollageViewControllerBase
...
-(void)showActionSheet{
    UIActionSheet __block *action;
    
        action = [[UIActionSheet alloc] initWithTitle:@"Select image from" delegate:self cancelButtonTitle:@"Cancel" destructiveButtonTitle:nil otherButtonTitles:@"From library",@"From camera", @"From Instagram", nil] ;
       
//    } disabled:^{
//        action = [[UIActionSheet alloc] initWithTitle:@"Select image from" delegate:self cancelButtonTitle:@"Cancel" destructiveButtonTitle:nil otherButtonTitles:@"From library",@"From camera", nil] ;
//        
//    }];
